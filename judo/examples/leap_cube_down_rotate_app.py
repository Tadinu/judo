...
# judo
from judo.tasks.leap_cube_down import LeapCubeDownConfig
...
@hydra.main(config_path=str(CONFIG_PATH), config_name="judo_dora_leap_cube_down", version_base="1.3")
...
if __name__ == "__main__":
    fetch_cfgs()
    app = LeapCubeDownRotateApp(task_registration_cfg=task_reg_cfg,
