...
from judo.tasks.leap_object_rotate import LeapObjectRotateConfig
...
class LeapObjectRotateApp(MPCApp):
    def __init__(self,
...
@hydra.main(config_path=str(CONFIG_PATH), config_name="judo_dora_leap_object_rotate", version_base="1.3")
...
if __name__ == "__main__":
    fetch_cfgs()
    app = LeapObjectRotateApp(task_registration_cfg=task_reg_cfg,
